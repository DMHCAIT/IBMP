          ...
          >
            <div className="relative">
              <input
                ...
                className="w-full px-6 py-4 pl-14 bg-white rounded-full border-2 border-gray-200 focus:outline-none focus:border-secondary focus:ring-2 focus:ring-secondary-100 text-lg transition-all shadow-sm"
              />
              <svg
