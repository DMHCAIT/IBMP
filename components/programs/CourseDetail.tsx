                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center pb-3 border-b border-white/20">
                      <span className="text-white/80 shrink-0 mr-4">Duration</span>
                      <span className="font-semibold text-right">{course.duration}</span>
                    </div>
                    <div className="flex justify-between items-start pb-3 border-b border-white/20">
                      <span className="text-white/80 shrink-0 mr-4">Credential</span>
                      <span className="font-semibold text-right">{course.credential}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-white/80 shrink-0 mr-4">Category</span>
                      <span className="font-semibold text-right">{categoryLabels[course.category]}</span>
                    </div>
                  </div>
                </motion.div>
