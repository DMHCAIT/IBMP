  ...
  return (
    <section ref={ref} className="relative py-12 bg-gradient-to-br from-primary via-primary-800 to-secondary overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold text-sm rounded-full mb-6 shadow-lg">
            ...
            {content.features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 hover:border-white/40 transition-all duration-300"
                >
                  <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
