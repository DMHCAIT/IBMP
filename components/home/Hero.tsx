...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative min-h-[500px] sm:min-h-[550px] md:min-h-[600px] flex items-center overflow-hidden bg-white">
      ...
      <div className="container-custom relative z-10 py-4 sm:py-6 md:py-10 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-2 sm:space-y-4">
              <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-primary leading-tight sm:leading-[0.9] tracking-tight text-left">
                ...
                <span className="relative inline-block">
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-0.5 sm:bottom-1 md:bottom-2 left-0 right-0 h-1 sm:h-2 md:h-3 bg-secondary/20 origin-left"
                  />
                </span>
                <br />
              ...
              <p className="text-sm sm:text-lg md:text-2xl text-gray-600 leading-relaxed max-w-2xl text-left">
                {content.description}
              </p>
            </div>
            ...
            <motion.div 
              ...
              className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto pt-2 sm:pt-4"
            >
              {/* Button 1: Apply for Accreditation */}
              <Link 
                href="/contact"
                className="group relative w-full sm:w-auto px-6 py-3 bg-white border-2 border-primary text-primary font-bold rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/20 whitespace-nowrap"
              >
              ...
              <button 
                ...
                className="group relative w-full sm:w-auto px-6 py-3 bg-secondary text-white font-bold rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-secondary/30 whitespace-nowrap"
              >
            ...
            <motion.div 
              ...
              className="grid grid-cols-3 gap-3 sm:gap-6 pt-3 sm:pt-6 border-t-2 border-gray-200 max-w-xl"
            >
              {[
                ...
                >
                  <div className={`text-lg sm:text-2xl md:text-3xl font-black bg-gradient-to-r ${stat.color} bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300`}>
                    {stat.value}
                  </div>
