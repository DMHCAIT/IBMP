  ...
  courses: {
    medicalSpecialties: [
      ...
      },
      {
        ...
        shortDescription: "Advanced skills in minimally invasive and joint replacement surgery for superior joint care",
        fullDescription: "The Fellowship in Arthroscopy and Arthroplasty offers specialized training in minimally invasive joint surgeries and advanced joint replacements. This program helps fellows develop expertise in diagnosing and treating joint disorders, sports injuries, and degenerative diseases. Through hands-on practice, fellows learn to perform arthroscopic procedures and joint replacements for the hip, knee, and shoulder, preparing them for orthopedic roles focused on restoring movement and improving patient quality of life.",
        category: "medical-specialties",
        duration: "12 Months",
        credential: "FIBMP (Arthroscopy and Arthroplasty)",
        image: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=800&q=80",
        eligibility: [
          "MBBS/MD/MS or equivalent medical degree",
          "Valid medical license/registration",
          "No previous experience is needed",
          "No entrance exam needed"
        ],
        curriculum: [
          { module: "Introduction to Arthroscopy and Arthroplasty", topics: ["Overview of Arthroscopic Surgery", "History and Evolution of Arthroplasty", "Indications and Contraindications", "Equipment and Instrumentation"] },
          { module: "Anatomy and Pathophysiology", topics: ["Joint Anatomy (Knee, Shoulder, Hip)", "Pathophysiology of Joint Disorders", "Sports Injuries and Degenerative Diseases", "Biomechanics of Joint Movement"] },
          { module: "Diagnostic Arthroscopy", topics: ["Diagnostic Techniques", "Imaging and Investigations", "Arthroscopic Anatomy", "Clinical Decision Making"] },
          { module: "Basic Arthroplasty Procedures", topics: ["Total Knee Replacement", "Total Hip Replacement", "Shoulder Arthroplasty Basics", "Implant Selection and Fixation"] },
          { module: "Advanced Arthroscopic Techniques", topics: ["Rotator Cuff Repair", "ACL/PCL Reconstruction", "Meniscal Surgery", "Labral Repair"] },
          { module: "Advanced Arthroplasty Procedures", topics: ["Complex Primary Arthroplasty", "Unicompartmental Knee Arthroplasty", "Reverse Shoulder Arthroplasty", "Minimally Invasive Approaches"] },
          { module: "Research and Innovation", topics: ["Evidence-Based Orthopedics", "Clinical Research Methods", "Outcome Measurements", "Publishing and Presentation"] },
          { module: "Emerging Technologies and Techniques", topics: ["Robotic-Assisted Surgery", "Computer Navigation", "3D Printing in Orthopedics", "Biologic Augmentation"] },
          { module: "Revision Arthroplasty", topics: ["Causes of Implant Failure", "Pre-operative Planning for Revision", "Revision Surgical Techniques", "Managing Complications"] }
        ],
        learningOutcomes: [
          "Fundamentals of arthroscopy and joint replacement surgery",
          "Minimally invasive techniques for diagnosing and treating joint issues",
          "Hands-on training in arthroscopic procedures for the knee, shoulder, and hip",
          "Advanced techniques for total and partial joint replacements",
          "Management of sports injuries and degenerative joint diseases",
          "Preoperative planning and postoperative rehabilitation strategies",
          "Improving surgical precision and patient recovery outcomes",
          "Real-world case studies and practical surgical experience"
        ],
        assessmentMethods: [
          "Participation in hands-on training sessions",
          "Completion of project and case studies",
          "Performance evaluations by course instructors"
        ],
        careerOpportunities: [
          "Orthopedic Surgeon (Joint Specialist)",
          "Sports Medicine Surgeon",
          "Arthroscopic Surgery Consultant",
        ...
        pricing: {
          ...
          installments: {
            available: true,
            plans: [
              { months: 3, monthlyAmount: 1667 },
              { months: 6, monthlyAmount: 834 },
              { months: 12, monthlyAmount: 417 }
            ]
          }
        },
        counselorContact: {
          enabled: true,
          phone: '+1 (302) 600-2718',
          email: 'info@ibmpractitioner.us',
          whatsapp: '+1 (302) 600-2718',
          buttonText: 'Talk to Counselor'
        },
        isActive: true
      },
      {
        id: "ms-027",
        slug: "clinical-nutrition-diabetics",
        name: "Fellowship in Clinical Nutrition and Diabetics",
        shortDescription: "Advanced training in nutrition, diet planning, and therapeutic diet management for various health conditions",
        fullDescription: "The Fellowship in Clinical Nutrition and Diabetics is a comprehensive, specialized program designed for healthcare professionals seeking expertise in nutrition and diabetics. It focuses on evidence-based nutritional practices, therapeutic diet management, and personalized dietary interventions for various medical conditions. The fellowship includes in-depth training on assessing nutritional needs, managing diet-related diseases, and promoting overall health and wellness. Graduates of this program gain advanced skills in clinical nutrition, preparing them for leadership roles in healthcare settings, hospitals, and wellness centers.",
        category: "medical-specialties",
        duration: "12 Months",
        credential: "FIBMP (Clinical Nutrition and Diabetics)",
        image: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=800&q=80",
        eligibility: [
          "MBBS/MS or equivalent medical degree",
          "No previous experience is needed",
          "No entrance exam needed",
          "Full lifetime access"
        ],
        curriculum: [
          { module: "Foundations of Nutrition", topics: ["Introduction to Human Biology and Body Functions", "Nutrients (Role and Significance)", "Understanding Nutrition (Basic diets for normal conditions/RDA)", "Advanced Nutrition"] },
          { module: "Nutraceuticals & Special Conditions", topics: ["Introduction to Nutraceuticals", "Introduction to Special Conditions and Diet Therapy", "Introduction to Clinical Nutrition", "Food Microbiology"] },
          { module: "Clinical & Biochemical Nutrition", topics: ["Recommend Approaches to Disease and Nutrition", "Nutritional Biochemistry", "Research Method Statistics", "Medical Nutrition Management"] },
          { module: "Specialized Nutrition", topics: ["Pathophysiology and Metabolism in Disease", "Public Nutrition and Health", "Pediatric and Geriatric Nutrition", "Food Allergies and Diet Management"] },
          { module: "Practical Training", topics: ["Case Studies", "Internship with Project Report"] }
        ],
        learningOutcomes: [
          "In-depth knowledge of clinical nutrition and diabetics",
          "Skills to assess and manage nutritional needs for various health conditions",
          "Expertise in creating personalized therapeutic diet plans",
          "Understanding of nutrition's role in disease prevention and management",
          "Ability to work with multidisciplinary healthcare teams",
          "Knowledge of current trends and research in nutrition science",
          "Practical experience in clinical settings and patient care",
          "Enhanced ability to educate patients on healthy eating and lifestyle choices"
        ],
        assessmentMethods: [
          "Participation in hands-on training sessions",
          "Completion of project and case studies",
        ...
        pricing: {
          ...
          installments: {
            available: true,
            plans: [
              { months: 3, monthlyAmount: 500 },
              { months: 6, monthlyAmount: 250 },
              { months: 12, monthlyAmount: 125 }
            ]
          }
        },
        counselorContact: {
