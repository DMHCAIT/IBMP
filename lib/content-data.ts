...
export const defaultContent: SiteContent = {
  hero: {
    certificationLine: "ISO 9001:2015 Certified • Established 2000",
    heading: {
      line1: "International",
      line2: "Board of",
  ...
  verification: {
    ...
    description: "Verify the authenticity of IBMP accreditation certificates and credentials",
    formTitle: "Certificate Verification",
    formDescription: "Enter certificate number to verify authenticity",
    inputLabel: "Certificate Number",
    inputPlaceholder: "Enter certificate number",
